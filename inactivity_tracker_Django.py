...
# TO USE THE SCRIPT IN YOUR DJANGO APPLICATION WRITE "import inactivity_tracker_Django.py" IN YOUR APPLICATION FILE AND START THE MODULE WITH start_timer_thread() SOMEWHERE IN THE BEGINNING OF YOUR APPLICATION FILE
